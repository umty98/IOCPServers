...
private:
    ...
    static volatile LONG globalCount;
    ...
    static const size_t FREE_LIST_THRESHOLD = 4000;
    static const size_t REMAIN_BALANCE_THRESHOLD = 4000;
...
public:
    ...
    void free(U* object)
    {
        InterlockedDecrement(&globalCount);
    ...
    static LONG GetCount() { return globalCount; }
private:
...
template<typename U>
volatile LONG TLSMemoryPool<U>::globalCount = 0;